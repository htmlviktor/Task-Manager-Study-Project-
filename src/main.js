...
// вставляем елементы
addMarkupElement(mainControl, markupElementMainMenu());
addMarkupElement(main, markupElementSearch());
addMarkupElement(main, markupElementFilter());
addMarkupElement(main, markupElementContent());
